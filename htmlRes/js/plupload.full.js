...
(function() {
	...
	var g = {
		...
		FAILED : 4,
		DONE : 5,
		GENERIC_ERROR : -100/*'파일 첨부중 오류가 발생하였습니다.(-100)'*/,
		HTTP_ERROR : -200/*'파일 첨부중 통신 오류가 발생하였습니다.(-200)'*/,
		IO_ERROR : -300/*'파일 첨부중 입력 오류가 발생하였습니다(-300)'*/,
		SECURITY_ERROR : -400/*'파일 첨부중 접근 오류가 발생하였습니다.(-400)'*/,
		INIT_ERROR : -500/*'파일 첨부중 오류가 발생하였습니다.(-500)'*/,
		FILE_SIZE_ERROR : -600/*'파일 사이즈를 확인해주세요.(-600)'*/,
		FILE_EXTENSION_ERROR : -601/*'파일 확장자를 확인해주세요.(-601)'*/,
		IMAGE_FORMAT_ERROR : -700/*'이미지 서식을 확인해주세요.(-700)'*/,
		IMAGE_MEMORY_ERROR : -701/*'이미지 첨부중 오류가 발생하였습니다.(-701)'*/,
		IMAGE_DIMENSIONS_ERROR : -702/*'이미지 크기를 확인해주세요.(-702)'*/,
		mimeTypes : j,
		ua : (function() {
					...
					"flash",
					{
						...
						init : function(n, p) {
							...
							(function() {
								...
								if (d.ua.ie) {
									q += 'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0" '
								}
								q += 'width="100%" height="100%" style="outline:0"><param name="movie" value="'
										+ n.settings.flash_swf_url
										+ '" /><embed src="'
										+ n.settings.flash_swf_url
										+ '"  ></embed><param name="flashvars" value="id='
										+ escape(n.id)
